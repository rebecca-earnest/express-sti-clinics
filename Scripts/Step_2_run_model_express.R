...
source(here('Files/make_matrix_safe.R'))
source(here('Files/param_express.R'))
source(here('Files/init.R'))
source(here('Files/control_express.R'))
...
fsimno <- paste("o55", "paper2", "express","061420", jobno, sep = ".")
...
rgc.asympt.prob.screen.B.xpr <- 1 
rgc.asympt.prob.screen.W.xpr <- 1 
ogc.asympt.prob.screen.B.xpr <- 1 
ogc.asympt.prob.screen.W.xpr <- 1 
...
param <- param_msm(nwstats = st,
                   ...
                   rgc.asympt.prob.screen.B.xpr = rgc.asympt.prob.screen.B.xpr, 
                   rgc.asympt.prob.screen.W.xpr = rgc.asympt.prob.screen.W.xpr,
                   ogc.asympt.prob.screen.B.xpr = ogc.asympt.prob.screen.B.xpr,
                   ogc.asympt.prob.screen.W.xpr = ogc.asympt.prob.screen.W.xpr,
...
control <- control_msm(simno = fsimno,
                       initialize.FUN = reinit_msm,
                       start = 3120, 
                       nsteps = 3125,  # run for 5 years, 3381
                       ncores = 1, #64
                       nsims = 2, #128
                       verbose = FALSE,
                       save.nwstats = FALSE)
