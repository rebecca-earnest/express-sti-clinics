...
param_msm <- function(nwstats = st,
                      ...
                      rgc.asympt.prob.screen.B.xpr = 0.375, 
                      rgc.asympt.prob.screen.W.xpr = 0.375,
                      ogc.asympt.prob.screen.B.xpr = 0.375,
                      ogc.asympt.prob.screen.W.xpr = 0.375,
                      prop.xpr.path = 0.5,
                      capacity.constraint.trad = 10000,
                      capacity.constraint.xpr = 10000,
